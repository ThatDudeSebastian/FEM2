...
- **Original:** Linearisierter Ansatz (`B`-Matrix), der Verschiebungen direkt als Verzerrungen interpretiert.
  - _Problem:_ Bei einer Drehung des Stabes (ohne Dehnung) ändern sich die Koordinaten. Der lineare Ansatz interpretiert dies fälschlicherweise als riesige Dehnung $\to$ Explosion der Kräfte.
- **Änderung:** Implementierung der **Co-Rotational Formulation**:
  ...
  3.  **Interne Kräfte:** Vektor zeigt immer exakt in die _aktuelle_ Stabrichtung `n`.
